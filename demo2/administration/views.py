...
from reservation.models import Box,Site,Reservation, Etudiant
...
@login_required
def annuler_reservationAdmin(request, id):
    reservation = get_object_or_404(Reservation, id=id)
    ...
    return render(request, 'administration/confirmation_annulationAdmin.html', {
        'reservation': reservation
    })
...
def modifier_reservation(request, reservation_id):
    ...
    return render(request, 'administration/modifier_reservationAdmin.html', {'form': form})
